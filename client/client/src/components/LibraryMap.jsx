 ...
 *
 * Floor plan: three zones (Reading Alcove, Long Table Hall, Group Study Pods)
 * separated by bookshelf dividers, with circulation desk, windows, plants.
 * Uses STATUS tokens from src/lib/theme.js.
 */
  ...
  return (
    <div style={{ display: 'flex', width: '100%', justifyContent: 'center', overflow: 'hidden' }}>
      <svg
        ...
        style={{ display: 'block', height: 'auto', width: '100%', maxWidth: SVG_W }}
      ...
      >
        ...
        {/* Zone labels */}
        <RoomTag x={92}  y={160}  label="READING ALCOVE"   />
        <RoomTag x={404} y={160}  label="LONG TABLE HALL"  />
        <RoomTag x={748} y={160}  label="GROUP STUDY PODS" />
                ...
                <g style={{ pointerEvents: 'none' }}>
                  ...
                  <text x={x+DESK_W/2} y={y-20} textAnchor="middle" fill="#F3EFE6" fontSize="10">
                    {desk.student_id
                      ...
                      : clickable ? 'Click to check in' : s.label}
                  </text>
                </g>
              )}
            </g>
